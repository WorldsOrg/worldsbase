...
class HTTP implements INode {
    ...
    constructor() {
        this.label = 'Add Currency'
        this.name = 'http_add_buzz'
        this.icon = 'add_buzz_http.png'
        this.type = 'action'
        this.category = 'Other'
        this.version = 1.0
        this.description = 'Calls Add Currency API'
        this.incoming = 1
        this.outgoing = 1
        this.actions = [
            {
    ...
    async run(nodeData: INodeData): Promise<INodeExecutionData[] | null> {
        ...
        const url = 'https://civitaiserver-production.up.railway.app/addCurrency'
