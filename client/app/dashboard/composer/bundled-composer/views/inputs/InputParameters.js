                  ...
                  return (
                    <FormControl key={inputName} fullWidth sx={{ mb: 1, mt: 1 }} error={Boolean(errors[inputName])}>
                      ...
                      <Button variant="outlined" component="label" fullWidth startIcon={<IconUpload />} sx={{ marginRight: "1rem" }}>
                        ...
                        {input.type === "file" && <input type="file" hidden onChange={(e) => handleFileUpload(e, setFieldValue, values, inputName)} />}
                        {input.type === "folder" && (
                          <input
                            type="file"
                  ...
                  return (
                    <FormControl key={inputName} fullWidth sx={{ mb: 1, mt: 1 }}>
                      ...
                      <Autocomplete
                        ...
                        renderInput={(params) => <TextField {...params} value={values[inputName]} error={Boolean(errors[inputName])} />}
                        renderOption={(props, option) => (
                          <Box component="li" {...props}>
                            <div style={{ display: "flex", flexDirection: "column" }}>
                              ...
                              {option.description && <Typography sx={{ p: 1, color: customization.isDarkMode ? "#9e9e9e" : "" }}>{option.description}</Typography>}
                            </div>
                          </Box>
                        )}
                      />
