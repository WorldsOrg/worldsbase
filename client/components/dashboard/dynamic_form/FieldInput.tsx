  ...
  return (
    <div className="flex items-center mb-6">
      <div className="flex-grow mr-2">
        <label htmlFor="project-name" className="block text-sm font-medium leading-6 text-gray-900 dark:text-primary">
          Column name
        </label>
        <input
          type="text"
      ...
      {!editing && (
        <div className="flex-grow mr-2">
          ...
          >
            ...
            <option value="jsonb[]">Array</option>
          </select>
        </div>
      )}

      {editable && (
        <button className="rounded text-primary hover:text-red-700 mt-7" onClick={() => handleRemoveField(id)}>
