...
function Feature({
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-xl font-display text-slate-900 dark:text-slate-300">
        {feature.summary}
      </p>
    ...
    >
      <Container>
        <div className="max-w-2xl mx-auto md:text-center">
          <h2 className="text-3xl tracking-tight font-display text-slate-900 dark:text-slate-300 sm:text-4xl">
