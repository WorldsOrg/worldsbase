...
import app from "@/images/screenshots/app.png";
...
const features = [
  ...
  },
  {
    ...
    description:
      "All of your users organized into one place, with all of their details and a full history of their activity.",
    image: user,
  },
  {
    title: "Item management",
    description:
      "All of your items organized into one place with customisable fields.",
    image: user,
  },
  {
    title: "Achievements",
    description: "Easily create and manage achievements for your games.",
    image: user,
  },
  {
    title: "No code composer",
    description:
      "Create your own flows or use our pre-built ones to automate your games with our powerful no-code tool.",
    image: user,
  },
];
...
export function PrimaryFeatures() {
  ...
  return (
    <section
      ...
      className="relative pt-20 overflow-hidden bg-secondary pb-28 sm:py-32"
    >
