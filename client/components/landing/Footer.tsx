      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          ...
          <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
            ...
            <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
              <Button borderRadius="0.5rem" className="bg-white  dark:bg-[#1c1c1c] text-black text-sm dark:text-white border-neutral-200 dark:border-slate-800">
                Subscribe{" "}
              </Button>
            </div>
          </form>
        ...
        <div className="flex flex-col items-center py-10 border-t border-slate-400/10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link href="https://twitter.com/waifu_force" className="group" aria-label="TaxPal on Twitter">
            ...
            <Link href="https://github.com/Manifest-Git/wgs-mono" className="group" aria-label="TaxPal on GitHub">
              <svg aria-hidden="true" className="w-6 h-6 fill-slate-500 group-hover:fill-slate-700">
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">Copyright &copy; {new Date().getFullYear()} Worlds. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
