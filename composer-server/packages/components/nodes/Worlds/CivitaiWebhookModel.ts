...
class Webhook implements INode {
    ...
    constructor() {
        this.label = 'Favorite Detected on Model'
        this.icon = 'civitai_model.png'
        this.name = 'webhook_civitai_model'
        this.type = 'webhook'
        this.category = 'Other'
        this.version = 2.0
        this.description = 'Start workflow when new model detected'
        this.incoming = 0
        this.outgoing = 1
